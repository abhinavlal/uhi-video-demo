...
public class ConsultationRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomUrl = data.getStringExtra("url");
        setContentView(R.layout.activity_consultationroom);
    ...
    protected void onResume() {
        ...
        if (this.webView.getUrl() == null) {
            if (Build.VERSION.SDK_INT >= VERSION_CODES.M && this.isPendingPermissions()) {
